...
workerJson = {'locations': [
                     '1265 Sergeant Jon Stiles Dr, Highlands Ranch, CO',
                     '6675 Business Center Dr, Highlands Ranch, CO'
                  ]
            }
...
rabbitMQChannel.basic_publish(exchange='',routing_key='toMapsWorker', body=formattedJson)
